...
public class Car extends Vehicle implements Comparable<Car> {
	...
	*/
	public Car(String mfr2, String color2, int power2, int numWheels2, String model, int maxRange, double safetyRating, boolean AWD, double price) {
		super(mfr2, color2, power2, numWheels2);
		this.model = model;
