...
public class ElectricCar extends Car {
	...
	*/
	public ElectricCar(int power3, String mfr3, String color3, int numWheels3, String model3, int maxRange3, double safetyRating3, boolean AWD3, double price3, int rechargeTime, String batteryType) {
		super(power3, mfr3, color3, numWheels3, model3, maxRange3, safetyRating3, AWD3, price3);
